...
- ⚠️ **darwin/amd64** (Intel Mac) - Will build from source automatically
- ⚠️ **darwin/arm64** (Apple Silicon) - Will build from source automatically
...
**Version**: 1.8.0 (see the `VERSION` file for the current release)
